...
## Архитектура
Выбрана **YARCH**  — адаптация Clean Swift от Alfa-Bank. 
В основе лежат однонаправленный поток данных и строгое разделение ответственности. 
...
*   Контейнеры `DataFlow` — `Request`, `Response`, `ViewModel` для обмена данными строго в рамках одного Use Case-а.